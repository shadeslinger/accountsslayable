...
export default function NotFound() {
  return (
    <div className="max-w-2xl mx-auto px-4 py-24 text-center">
      <h1 className="font-[family-name:var(--font-montserrat)] font-bold text-6xl text-sage mb-4">
        404
      </h1>
      <h2 className="font-[family-name:var(--font-montserrat)] font-bold text-2xl text-charcoal mb-4">
